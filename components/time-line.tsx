          ...
          {dataAboutPage.map((data, i) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start mb-1
                ...
                before:px-px before:bg-white/15 sm:before:ml-[6.5rem]
                ...
                after:border-4 after:box-content after:border-[#05070d]
                after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2
                after:translate-y-1.5">
                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-[#8ca3ff] bg-[#3f5cff]/15 border border-[#3f5cff]/30 rounded-full">{t(data.dateKey)}</time>
